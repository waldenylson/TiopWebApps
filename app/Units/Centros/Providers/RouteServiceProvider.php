...
use TIOp\Units\Centros\Routes\Api;
use TIOp\Units\Centros\Routes\Console;
use TIOp\Units\Centros\Routes\Web;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'TIOp\Units\Centros\Controllers';
