...
use TIOp\Units\StatusDACOMData\Routes\Api;
use TIOp\Units\StatusDACOMData\Routes\Console;
use TIOp\Units\StatusDACOMData\Routes\Web;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'TIOp\Units\StatusDACOMData\Controllers';
