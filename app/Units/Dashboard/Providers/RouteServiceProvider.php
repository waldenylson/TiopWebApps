...
use TIOp\Units\Dashboard\Routes\Api;
use TIOp\Units\Dashboard\Routes\Console;
use TIOp\Units\Dashboard\Routes\Web;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'TIOp\Units\Dashboard\Controllers';
