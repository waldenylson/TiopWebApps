    ...
    <div class="inf-sistemas" >
        <div class="panel panel-primary">
            ...
            <div class="box box-bg-color" v-for="infSis in dadosInfSistemas" v-if="(infSis['sigla'] === 'ACC-RE') ">
                ...
                <i class="fa fa-calendar">&nbsp;&nbsp;ATL: <b>{{ infSis['dt_sistema'] | moment("DD/MM/YYYY") }}</b></i>
                <i class="fa fa-database">&nbsp;&nbsp;BDS: <b>{{ infSis['v_bds'] }}</b></i><br />
                <i class="fa fa-calendar">&nbsp;&nbsp;ATL: <b>{{ infSis['dt_bds'] | moment("DD/MM/YYYY") }}</b></i>
            </div>
