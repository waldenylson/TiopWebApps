              ...
              <div id="panel">
                <ul class="project_list">
                  <li v-for="(mntProg, index) in dadosMntProg" :key="mntProg.id" :id="index">
                    ...
                    <a class="project_title alinha-esquerda">
                      <b>{{ mntProg.radarNome }}</b>
                    </a>
                    <br />
                    <span class="fa fa-calendar data">
                      <a>
                        <b>&nbsp;{{ mntProg.data_ini }}</b>
                      </a>
                    </span>
                    <span class="data">
                      <a>
                        &nbsp;&nbsp;
                        <b class="fa fa-clock-o">&nbsp;{{ mntProg.hora_ini + 'Z'}}</b>
                      </a>
                    </span>
                    <br />
                    <span class="fa fa-calendar data">
                      <a>
                        <b>&nbsp;{{ mntProg.data_fim }}</b>
                      </a>
                    </span>
                    <span class="data">
                      <a>
                        &nbsp;&nbsp;
                        <b class="fa fa-clock-o">&nbsp;{{ mntProg.hora_fim + 'Z'}}</b>
                      </a>
                    </span>
                    <br />
                    <span class="motivo">{{ mntProg.motivo }}</span>
                    <br />
                  </li>
                </ul>
              </div>
