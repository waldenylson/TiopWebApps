...
use TIOp\Units\SistemasCentros\Routes\Api;
use TIOp\Units\SistemasCentros\Routes\Console;
use TIOp\Units\SistemasCentros\Routes\Web;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'TIOp\Units\SistemasCentros\Controllers';
